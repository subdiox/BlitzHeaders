...
@class CBAFMultipartBodyStream, NSMutableURLRequest, NSString;
...
@property(retain, nonatomic) CBAFMultipartBodyStream *bodyStream; // @synthesize bodyStream=_bodyStream;
