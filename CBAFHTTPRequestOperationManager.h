...
@class CBAFHTTPRequestSerializer<CBAFURLRequestSerialization>, CBAFHTTPResponseSerializer<CBAFURLResponseSerialization>, CBAFNetworkReachabilityManager, CBAFSecurityPolicy, NSOperationQueue, NSURL, NSURLCredential;
...
@property(retain, nonatomic) CBAFNetworkReachabilityManager *reachabilityManager; // @synthesize reachabilityManager=_reachabilityManager;
@property(retain, nonatomic) CBAFSecurityPolicy *securityPolicy; // @synthesize securityPolicy=_securityPolicy;
...
@property(retain, nonatomic) CBAFHTTPResponseSerializer<CBAFURLResponseSerialization> *responseSerializer; // @synthesize responseSerializer=_responseSerializer;
@property(retain, nonatomic) CBAFHTTPRequestSerializer<CBAFURLRequestSerialization> *requestSerializer; // @synthesize requestSerializer=_requestSerializer;
