...
@class CLSReportsController, CLSInternalReport, CLSNetworkClient, CLSFileManager, UIAlertView, NSString, NSOperationQueue, CLSSettings;
...
-(void)installCrashReportingHandlers:(XXStruct_69FNmD*)handlers;
