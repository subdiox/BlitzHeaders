...
@class FBAdBodyView, FBAdChoicesView, FBAdNativeContentContainer, FBMediaView, FBNativeAd, FBNativeAdViewAttributes, NSHashTable, NSString, UIButton, UIImageView, UILabel, UIViewController;
