...
@class NSError, CBAFHTTPBodyPart, NSEnumerator, NSMutableArray, NSOutputStream, NSMutableData, NSString;
...
@property(retain, nonatomic) CBAFHTTPBodyPart* currentHTTPBodyPart;
