...
- (id)initInternalWithPlacementId:(id)arg1 publisherId:(id)arg2 placementType:(long long)arg3 adSize:(struct FBAdSize)arg4 numAdsRequested:(unsigned long long)arg5;
- (id)initWithPlacementId:(id)arg1 placementType:(long long)arg2 adSize:(struct FBAdSize)arg3;
