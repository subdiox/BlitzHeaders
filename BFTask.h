...
@class NSError, NSException, NSCondition, NSMutableArray;
...
@property(assign, nonatomic, getter=isFaulted) BOOL faulted;
...
-(id)init;
-(id)waitForResult:(id*)result withMainThreadWarning:(BOOL)mainThreadWarning;
...
-(id)continueWithMainThreadBooleanResultBlock:(id)mainThreadBooleanResultBlock executeIfCancelled:(BOOL)cancelled;
-(id)continueWithMainThreadResultBlock:(id)mainThreadResultBlock executeIfCancelled:(BOOL)cancelled;
-(id)continueWithSuccessResult:(id)successResult;
-(id)continueWithResult:(id)result;
-(id)continueAsyncWithSuccessBlock:(id)successBlock;
-(id)continueAsyncWithBlock:(id)block;
@end
