...
@class FBAdImage, FBNativeAdViewAttributes, NSDictionary, NSNumber, NSString, NSURL;
...
@property(readonly, copy, nonatomic) NSURL *videoTimeReportURL; // @synthesize videoTimeReportURL=_videoTimeReportURL;
@property(readonly, copy, nonatomic) NSNumber *videoPlayReportTime; // @synthesize videoPlayReportTime=_videoPlayReportTime;
