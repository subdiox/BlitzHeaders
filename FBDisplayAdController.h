...
@class FBAdCandidate, FBAdEnvironmentData, FBAdPlacementDefinition, FBAdProvider, FBAdTimer, FBAdViewabilityValidator, FBDisplayAdAdapter, NSArray, NSString;
...
- (void)dealloc;
- (void)loadAdWithPlacementId:(id)arg1 withPlacementType:(long long)arg2 withAdSize:(struct FBAdSize)arg3 withAdProvider:(id)arg4;
- (void)loadAdWithPlacementId:(id)arg1 withPlacementType:(long long)arg2 withAdSize:(struct FBAdSize)arg3;
